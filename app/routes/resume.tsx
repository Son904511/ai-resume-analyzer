...
//load resume from key value store from puter
    useEffect(()=>{
        const loadResume=async()=>{
            ...
            // read pdf file and any fs using blobs
    ...
    <main className='!pt-0'>
        ...
        <div className="flex flex-row w-full max-lg:flex-col-reverse">
            <section className='feedback-section bg-[url(/images/bg-small.svg)] bg-cover h-[100vh] sticky top-0 items-center justify-center'>
                {imageUrl && resumeUrl &&(
                    <div className='animate-in fade-in gradient-border duration-1000 max-sm:m-0 h-[90%] max-wxl:h-fit w-fit'>
                        <a href={resumeUrl} target="_blank" rel="noopener noreferrer" className='flex flex-col items-center justify-center h-full w-full'>
